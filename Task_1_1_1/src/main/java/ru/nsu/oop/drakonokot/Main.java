...
/**
 * Класс реализует пирамидальную сортировку для массива целых чисел. Используется минимальная куча.
 * Асимптотика времени O(n log n). Асимптотика памяти O(n).
 *
 * @author drakonokot
 * @see #heapSort(int[])
 */
public class Main {
    ...
    /**
     * Извлекает минимальный элемент из кучи и восстанавливает ее структуру, путем просеивание вниз
     * крайнего элемента в плоском массиве кучи.
     *
     * @param heap    сама куча
     * @param heapEnd индекс конца кучи
    ...
    /**
     * Непосредственно сортировка: 1) Заполняем кучу. 2) переписываем изначальный массив доставая
     * минимальные элементы из кучи.
     *
